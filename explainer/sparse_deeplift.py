...
class SparseDeepLIFTRescaleExplainer(SparseExplainer):
    def __init__(self, model):
        super(SparseDeepLIFTRescaleExplainer, self).__init__(model)
    ...
    def explain(self, inp, ind=None):
        ...
        g = super(SparseDeepLIFTRescaleExplainer, self).explain(inp, ind)
